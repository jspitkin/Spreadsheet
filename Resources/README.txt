...
!!!!!!!!MESSAGE TO GRADER!!!!!!!!!!!!
WHEN GRADING:
For some unknown reason, Resources is set as the startup project
and SpreadsheetGUI's references become broken when I pull the solution
from SVN.

TO FIX:
Set SpreadsheetGUI as the StartUp Project and re-add "Formula",
"SpreadsheetPanel" and "SpreadsheetUtilities" to SpreadsheetGUI's
references.